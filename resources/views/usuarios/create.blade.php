...
<div class="bg-white rounded-lg shadow p-6 max-w-lg">
    <form action="{{ route('usuarios.store') }}" method="POST">
        ...
        <div class="mb-4">
            ...
            <input type="password" name="password" id="password" class="w-full rounded-md border-gray-300 shadow-sm focus:border-emerald-500 focus:ring-emerald-500 text-sm" required>
